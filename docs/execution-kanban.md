...
| Observability and alerts | 5 | 0 | 6 | 1 |
...
2. Continue P3.4: add ClickHouse source-observation tables, source precedence, cross-source disagreement checks, and daily gap/source-disagreement panels.
3. During market hours, resolve P3.4a IB API market-data entitlement/session-IP blocker and rerun a 1-symbol live ETF canary before any 5-symbol or 30-40-symbol capture.
4. Start P4.1: define the versioned strategy spec schema.
5. Start P6.1: define service, data, queue, strategy, portfolio, execution, and reconciliation metrics.
6. Start P5.1: define the stronger rebalance blotter domain model.
